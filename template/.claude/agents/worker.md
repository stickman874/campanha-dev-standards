---
name: worker
description: Unattended worker for scoped edits and code searches (subagent called by the core:worker skill). No shell, no subagents, no web; files only through the native tools.
model: haiku
