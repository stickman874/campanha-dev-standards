...
- You have no shell: do not try to run tests, builds or git. If the task has a `Test:` line, the caller runs it after you and sends you any failure. Say which other commands the caller should run to verify.
